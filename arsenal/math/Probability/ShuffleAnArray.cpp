...
// Given an array size n, return one of it's permutation,
// the probability of returning any one of n! permutations must be the same.
...
//
// The probability that ith element goes to second last position can be proved
// to be 1/n by dividing it in two cases.
